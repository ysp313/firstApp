package fr.ysp.first.web.rest;

import static fr.ysp.first.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import fr.ysp.first.IntegrationTest;
import fr.ysp.first.config.Constants;
import fr.ysp.first.domain.User;
import fr.ysp.first.repository.AuthorityRepository;
import fr.ysp.first.repository.UserRepository;
import fr.ysp.first.security.AuthoritiesConstants;
import fr.ysp.first.service.UserService;
import fr.ysp.first.service.dto.AdminUserDTO;
import fr.ysp.first.service.dto.PasswordChangeDTO;
import fr.ysp.first.service.dto.UserDTO;
import fr.ysp.first.web.rest.vm.KeyAndPasswordVM;
import fr.ysp.first.web.rest.vm.ManagedUserVM;
